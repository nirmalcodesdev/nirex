...
export const plans: PricingPlans = [
    {
        ...
        features: [
            ...
            'Top-up packs available (balance never expires)',
    ...
    },
    {
        ...
        trialDays: 0,
        features: [
            '$7.50 included balance/mo',
            '10,000 monthly requests',
            'Top-up packs unlock unlimited requests',
    ...
    },
    {
        ...
        features: [
            ...
            'Save $40/yr with annual billing ($200/yr)',
        ],
        cta: 'Start Pro',
        highlight: true,
    },
    {
        ...
        features: [
            ...
            'Save $100/yr with annual billing ($500/yr)',
        ],
        cta: 'Start Plus',
        highlight: false,
    },
    {
        ...
        features: [
            ...
            'Top-up packs for extra balance',
