...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Nirex from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}nirex serve{/highlight} for headless API access to Nirex",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/nirex-ai/nirex{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Nirex Zen for curated, tested models",
